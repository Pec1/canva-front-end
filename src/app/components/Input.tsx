        ...
        return (
            <div className="relative input-container">
                <input
                    ...
                    className={`w-[372px] h-[68px] bg-gray-300 text-base text-[#1c1c1c] border-[3px] rounded-md pl-3 pr-3 focus:outline-none focus:text-xl placeholder-black font-bold placeholder-opacity-75 ${
